...
import { renderLayout, appShell } from '../components/layout.js?v=sidebar-logout-20260812';
...
if (user) {
  document.body.innerHTML = appShell('Dasbor', `
    ...
    <div class="dashboard-hero mb-3">
      ...
      <div class="dashboard-hero-mark"><img src="assets/mbos.png?v=sidebar-logout-20260812" alt="Logo MBOS"></div>
    </div>
